      ...
      >
        <Select.Content position="popper" className="SelectContent">
          ...
          <Select.Viewport className="SelectViewport">
            ...
            {props.type == "camera" && contentState.videoInput && Array.isArray(contentState.videoInput) && contentState.videoInput.length > 0 && (
              <Select.Separator className="SelectSeparator" />
            )}
            {props.type == "mic" && contentState.audioInput && Array.isArray(contentState.audioInput) && contentState.audioInput.length > 0 && (
              <Select.Separator className="SelectSeparator" />
            )}
            <Select.Group>
              {props.type == "camera" &&
                contentState.videoInput &&
                Array.isArray(contentState.videoInput) &&
