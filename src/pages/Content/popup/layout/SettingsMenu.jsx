          ...
          chrome.runtime
            ...
            .then((response) => {
              ...
              zip.generateAsync({ type: "blob" }).then(function (blob) {
                ...
                a.href = url;
                a.download = "trupeer-ai-troubleshooting.zip";
                a.click();
          ...
          >
            ...
            <DropdownMenu.Portal>
              <DropdownMenu.SubContent
                className="TrupeerAIDropdownMenuContent"
                sideOffset={0}
                alignOffset={-3}
              >
                <TooltipWrap
                ...
                >
                  <DropdownMenu.Item
                    className="TrupeerAIDropdownMenuItem"
                    onClick={(e) => {
                      chrome.runtime.sendMessage({
                        type: "resize-window",
                        width: 3840,
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      4k
                      <DropdownMenu.ItemIndicator className="TrupeerAIItemIndicator">
