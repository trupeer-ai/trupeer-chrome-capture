...
const RecordingType = (props) => {
  ...
  const [URL, setURL] = useState(
    "https://help.trupeer-ai.io/getting-started/77KizPC8MHVGfpKpqdux9D/what-are-the-technical-requirements-for-using-trupeer-ai/6kdB6qru6naVD8ZLFvX3m9"
  );
  ...
  useEffect(() => {
    ...
    if (!locale.includes("en")) {
      setURL(
        `https://translate.google.com/translate?sl=en&tl=${locale}&u=https://help.trupeer-ai.io/getting-started/77KizPC8MHVGfpKpqdux9D/what-are-the-technical-requirements-for-using-trupeer-ai/6kdB6qru6naVD8ZLFvX3m9`
      );
      setURL2(
        `https://translate.google.com/translate?sl=en&tl=${locale}&u=https://help.trupeer-ai.io/troubleshooting/9Jy5RGjNrBB42hqUdREQ7W/how-to-grant-trupeer-ai-permission-to-record-your-camera-and-microphone/x6U69TnrbMjy5CQ96Er2E9`
      );
    }
  }, []);
  ...
  const micUnavailableCheck = !contentState.micActive;
  ...
  const buttonStyle = {
    ...
    background: isHovered
      ? "linear-gradient(to bottom, #6F66C5, #6055AD)"
      : "linear-gradient(to bottom, #817FD5, #6F66C5)",
    border: "none",
    cursor: "pointer",
    transition: "background 0.2s ease",
    // Disabled state
    ...(micUnavailableCheck || contentState.pendingRecording
      ? {
          color: "#9CA3AF",
          background: "#E5E7EB",
          cursor: "not-allowed",
  ...
  return (
    <div>
      ...
      {/* FEATURE_DISABLED {!contentState.cameraPermission && (
        <button
      ...
      {((contentState.microphonePermission &&
        ...
        <div>
          ...
          <Switch
            ...
            value="hideUI"
          />
          <Switch label={"Input Language"} name="languageSelector" value="en" />
        </div>
      )}
      ...
      <button
        ...
        disabled={contentState.pendingRecording || micUnavailableCheck}
      >
        ...
        <span className="main-button-label">
          {contentState.pendingRecording
            ...
            : micUnavailableCheck
            ? chrome.i18n.getMessage("recordButtonNoMicLabel")
