...
const CountdownGif = `${URL}/countdown-gif.gif`;
const CountdownImg = `${URL}/countdown-img.png`;
const CountdownVisual = `${URL}/CountdownVisual.png`;
const CountdownText = `${URL}/CountdownText.png`;
