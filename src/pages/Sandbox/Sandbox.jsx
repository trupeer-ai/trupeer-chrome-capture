...
.trupeer-ai-scrollbar *::-webkit-scrollbar, .trupeer-ai-scrollbar::-webkit-scrollbar {
  background-color: rgba(0,0,0,0);
  width: 16px;
  height: 16px;
  z-index: 999999;
}
.trupeer-ai-scrollbar *::-webkit-scrollbar-track, .trupeer-ai-scrollbar::-webkit-scrollbar-track {
  background-color: rgba(0,0,0,0);
}
.trupeer-ai-scrollbar *::-webkit-scrollbar-thumb, .trupeer-ai-scrollbar::-webkit-scrollbar-thumb {
  background-color: rgba(0,0,0,0);
  border-radius:16px;
  border:0px solid #fff;
}
.trupeer-ai-scrollbar *::-webkit-scrollbar-button, .trupeer-ai-scrollbar::-webkit-scrollbar-button {
  display:none;
}
.trupeer-ai-scrollbar *:hover::-webkit-scrollbar-thumb, .trupeer-ai-scrollbar:hover::-webkit-scrollbar-thumb {
...
.videoBanner {
	...
	top: 0px!important;
	left: 0px!important;
	background-color: #6f66c5!important;
	color: #FFF!important;
